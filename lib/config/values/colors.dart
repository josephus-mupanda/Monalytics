...
class AppColors {
  ...
  static const kPrimaryColor = Color(0xff000000); // Color(0xFFFF3B1D);
  static const kDarkBlackColor = Color(0xFF191919);

  static const kItemsBlueColor = Color(0xff412482);
  static const kThemeYellow = Color( 0xffffc421 );
  static const kThemeDarkYellowShadow = Color( 0xfffbf3d8);

  static const kLightBlackColor = Color(0xFF191919);
  static const kGreenColor =  Color(0xffd1800d);


  //static const secondary = Color(0xffa6a6a6);

  static const lightSecondaryColor = Color(0xffececf6);
  static const darkSecondaryColor = Color.fromRGBO(38, 40, 55, 1); // Color(0xFF292929);

  static const darkBgColor = Color.fromRGBO(31, 29, 44, 1) ;  //Color(0xFF212121);
  static const lightBgColor = Color(0xfffaf8ec); // Color(0xffe3e3ee);//This one

  static const Color primaryColor = Color(0xffd1800d); //Color(0xFFF6C350);
