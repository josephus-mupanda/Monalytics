...
class AboutChurchCard extends StatefulWidget {
  const AboutChurchCard({
    this.leading,
    this.title,
    this.subtitle,
    this.trailing,
  ...
  @override
  _AboutChurchCardState createState() => _AboutChurchCardState();
}

class _AboutChurchCardState extends State<AboutChurchCard>
