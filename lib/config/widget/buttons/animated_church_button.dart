...
class AnimatedChurchButton extends StatefulWidget {
  final String title;
  ...
  @override
  _AnimatedChurchButtonState createState() => _AnimatedChurchButtonState();
}

class _AnimatedChurchButtonState extends State<AnimatedChurchButton> {
